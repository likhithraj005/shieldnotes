    ...
    <div className=" p-8   bg-gray-100 min-h-screen">
      <div className="md:w-1/2">
        ...
        <div className="flex space-x-4 mt-10">
          ...
          <Link className="text-white rounded-full p-2 bg-customRed  " to="https://www.linkedin.com/in/likhith-raj005/">
            <FaLinkedinIn size={24} />
          </Link>
          <Link className="text-white rounded-full p-2 bg-customRed  " to="https://github.com/likhithraj005">
            <FaGithub size={24} />
          </Link>
          <Link className="text-white rounded-full p-2 bg-customRed  " to="https://www.instagram.com/likhithraj005/">
            <FaInstagram size={24} />
          </Link>
        </div>
      </div>
